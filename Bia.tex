...
{\textbf{\Large{Thiết kế  và xây dựng hệ thống mua bán NFT trên nền tảng Blockchain}}\\[1cm]

{\textbf{\large{NGUYỄN MẠNH KIÊN}}}\\
{\large{kien.nm207682@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
 \multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & PGS. TS. Cao Tuấn Dũng \hspace{0.5cm} 
  \\[0.5cm]
