...
\begin{figure}[H]
    ...
    \label{fig:package_diagram_overview}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:package_diagram_detail}
\end{figure}
...
Trạng thái bình thường: hiển thị rõ nội dung, dễ nhận biết.
Trạng thái hover/active (desktop): thay đổi sắc độ/viền để phản hồi thao tác.
Trạng thái disabled: giảm độ nổi bật để biểu thị không thể thao tác.
Trạng thái loading: hiển thị tiến trình khi hệ thống đang xử lý các thao tác như xác nhận giao dịch hoặc tải dữ liệu.

\textbf{Minh họa thiết kế giao diện}

Dưới đây là một số thiết kế giao diện cho một vài chức năng chính của hệ thống.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/connect_wallet_ui.png}
    \caption{Giao diện kết nối ví}
    \label{fig:connect_wallet_ui}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/list_nft_ui.png}
    \caption{Giao diện danh sách NFT}
    \label{fig:list_nft_ui}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/nft_detail_ui.png}
    \caption{Giao diện chi tiết NFT}
    \label{fig:nft_detail_ui}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/create_nft_ui.png}
    \caption{Giao diện tạo NFT}
    \label{fig:create_nft_ui}
\end{figure}
...
\textbf{Biểu đồ trình tự kết nối ví}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/bieu_do_tuan_tu_ket_noi_vi.png}
    \caption{Biểu đồ trình tự kết nối ví}
    \label{fig:connection_flow_sequence_diagram}
\end{figure}
...
image\_url & TEXT & URL ảnh NFT. \\ \hline
...
\textbf{Giao diện Trang chủ (Home Page)}

Trang chủ là nơi đầu tiên người dùng tiếp cận, cung cấp cái nhìn tổng quan về các NFT đang nổi bật, các bộ sưu tập mới nhất và các thông tin sự kiện.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/homepage_ui.png}
    \caption{Giao diện Trang chủ}
    \label{fig:homepage_ui}
\end{figure}

\textbf{Giao diện trang duyệt NFT}

Đây là nơi người dùng có thể tìm kiếm và khám phá toàn bộ các NFT đang được rao bán. Hệ thống cung cấp các công cụ lọc mạnh mẽ giúp người dùng tìm được sản phẩm ưng ý một cách nhanh chóng.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/list_nft_page_ui.png}
    \caption{Giao diện Trang duyệt NFT}
    \label{fig:list_nft_page_ui}
\end{figure}

\textbf{Giao diện trang chi tiết NFT}

Trang chi tiết NFT hiển thị toàn bộ thông tin về một NFT cụ thể. Đây là nơi người dùng mua hoặc đặt giá bán NFT. Thông tin bao gồm dữ liệu từ metadata (hình ảnh, thuộc tính) và dữ liệu từ blockchain (lịch sử giao dịch, chủ sở hữu).

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/nft_detail_page_ui.png}
    \caption{Giao diện Trang chi tiết NFT}
    \label{fig:nft_detail_page_ui}
\end{figure}

\textbf{Giao diện trang tạo NFT}

Cho phép người dùng trực tiếp tham gia vào việc tạo ra tài sản số. Người dùng tải lên tệp tin và nhập các thông tin mô tả, sau đó thực hiện giao dịch "Mint" để ghi dữ liệu lên blockchain.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/create_nft_page_ui.png}
    \caption{Giao diện Trang tạo NFT}
    \label{fig:create_nft_page_ui}
\end{figure}

\textbf{Giao diện trang Dashboard thống kê}

Cho phép người dùng theo dõi được các chỉ số thống kê về lợi nhuận, số lượng NFT đã niêm yết, số lượng giao dịch đã diễn ra và các thông tin thống kê liên quan khác.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Hinhve/user_dashboard_page_ui.png}
    \caption{Giao diện Trang Dashboard thống kê}
    \label{fig:user_dashboard_page_ui}
\end{figure}
...
Nhập giá bán, ký xác nhận niêm yết trên ví. &
